...
data = {
{
{text = '{ 𝟙 }', data = senderr..'/help1'}, {text = '{𝟚}', data = senderr..'/help2'}, 
},
{
{text = '{𝟛}', data = senderr..'/help3'}, {text = '{ 𝟜 }', data = senderr..'/help4'}, 
},
{
{text = '{ 𝟝}', data = senderr..'/help5'}, {text = '{ 𝟞 }', data = senderr..'/helpp6'}, 
},
{
