...
if text then
local neww = Redis:get(ZELZAL.."Get:Reides:Commands:Group"..msg.chat_id..":"..text)
if neww then
text = neww or text
end
end
...
if tonumber(rep_idd) == tonumber(ZELZAL) then
return send(msg.chat_id,msg.id,"ابعد عني يحيحان ملكقتش غيري","md",true)
end
if Redis:sismember(ZELZAL..msg.chat_id.."zwgat:",rep_idd) then
local rd_mtzwga = {
"مزوجه خويه لا تزحف",
"تريد تورطني وتخلي زوجي يطلكني",
"اهو يريد يزوجني اني ادور حلوين😹",
"ما ريد ازوجك زوجي مالي عيني",
"اقبل ازوجك مهري 100000000"
}
...
"مبروك اتزوجتها اريداتغدا بقا في الفرح",
"تم زواجكم... وهاذا رقمي حته اذا العريس ما عرف يسد 077156..",
"الزواج تم اتفضلو سوو احلا واحد بقا هيهيهي"
}
if Redis:sismember(ZELZAL..msg.chat_id.."mutlqat:",rep_idd) then 
Redis:srem(ZELZAL..msg.chat_id.."mutlqat:",rep_idd)
end
Redis:sadd(ZELZAL..msg.chat_id.."zwgat:",rep_idd) 
...
local zwgat_list = Redis:smembers(ZELZAL..msg.chat_id.."zwgat:")
...
if Redis:sismember(ZELZAL..msg.chat_id.."zwgat:",rep_idd) then
Redis:srem(ZELZAL..msg.chat_id.."zwgat:",rep_idd)
Redis:sadd(ZELZAL..msg.chat_id.."mutlqat:",rep_idd) 
local rd_tmtlaq = {
"تم طلاقكم للاسف",
...
local mutlqat_list = Redis:smembers(ZELZAL..msg.chat_id.."mutlqat:")
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
if tonumber(Redis:get(ZELZAL..msg.chat_id..rep_idd.."in_heart:")) == tonumber(senderr) then
...
elseif tonumber(rep_idd) == tonumber(ZELZAL) then
return send(msg.chat_id,msg.id,"ابعد عني يبن الهبله","md")
elseif Redis:get(ZELZAL..msg.chat_id..rep_idd.."in_heart:") then
return send(msg.chat_id,msg.id,"للاسف العضو فقلب حد تاني","md")
elseif tonumber(Redis:get(ZELZAL..msg.chat_id..rep_idd.."in_heart:")) ~= tonumber(senderr) and not Redis:get(ZELZAL..msg.chat_id..rep_idd.."in_heart:") then
Redis:set(ZELZAL..msg.chat_id..rep_idd.."in_heart:", senderr)
Redis:sadd(ZELZAL..msg.chat_id..senderr.."my_heart:", rep_idd)
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
if tonumber(Redis:get(ZELZAL..msg.chat_id..rep_idd.."in_heart:")) == tonumber(senderr) then
Redis:del(ZELZAL..msg.chat_id..rep_idd.."in_heart:")
Redis:srem(ZELZAL..msg.chat_id..senderr.."my_heart:", msg.chat_id..rep_idd)
...
elseif tonumber(rep_idd) == tonumber(ZELZAL) then
return send(msg.chat_id,msg.id,"ابعد عني يبن الهبله","md")
elseif tonumber(Redis:get(ZELZAL..msg.chat_id..rep_idd.."in_heart:")) ~= tonumber(senderr)then
return send(msg.chat_id,msg.id,"هو فقلبك اصلا عشان تنزلو ؟؟","md")
end
end
if text == "انا فقلب مين" then
if not Redis:get(ZELZAL..msg.chat_id..senderr.."in_heart:") then
return send(msg.chat_id,msg.id,"اقعد يعم انت محد طايقك","md")
elseif Redis:get(ZELZAL..msg.chat_id..senderr.."in_heart:") then
local in_heart_id = Redis:get(ZELZAL..msg.chat_id..senderr.."in_heart:")
...
local heart_list = Redis:smembers(ZELZAL..msg.chat_id..senderr.."my_heart:")
if #heart_list == 0 then
return send(msg.chat_id,msg.id,"قلبك فارغ محد فيه","md")
...
local list = Redis:smembers(ZELZAL..msg.chat_id..senderr.."my_heart:")
for k,v in pairs(list) do
Redis:del(ZELZAL..msg.chat_id..v.."in_heart:")
end
Redis:del(ZELZAL..msg.chat_id..senderr.."my_heart:")
...
Redis:set(ZELZAL..'zwgnyy'..msg.chat_id,true)
...
Redis:del(ZELZAL..'zwgnyy'..msg.chat_id)
send(msg.chat_id,msg.id,'\n •تم تفعيل امر زوجني')
end
if text == "زوجني" or text == "زوجني" then
if not Redis:get(ZELZAL..'zwgnyy'..msg.chat_id) then 
...
if tonumber(member_id) == tonumber(senderr) or tonumber(member_id) == tonumber(ZELZAL) or bot.getUser(member_id).type.bot == "userTypeBot" then 
...
if text == "تزوجيني" and msg.reply_to_message_id ~= 0 then
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
if tonumber(Redis:get(ZELZAL..msg.chat_id..rep_idd.."mtzwga:")) == tonumber(senderr) or tonumber(Redis:get(ZELZAL..msg.chat_id..senderr.."mtzwga:")) == tonumber(rep_idd) then
...
elseif Redis:get(ZELZAL..msg.chat_id..rep_idd.."mtzwga:") then
local zwg_id = Redis:get(ZELZAL..msg.chat_id..rep_idd.."mtzwga:")
...
elseif Redis:get(ZELZAL..msg.chat_id..senderr.."mtzwga:") then
local zwg_id = Redis:get(ZELZAL..msg.chat_id..senderr.."mtzwga:")
local zwg_info = bot.getUser(zwg_id)
return send(msg.chat_id,msg.id,"هناديلك مراتك\n["..FlterBio(zwg_info.first_name).."](tg://user?id="..zwg_id..")\nالحقي يا وليه جوزك تبغا يتجوز عليكي","md")
elseif not Redis:get(ZELZAL..msg.chat_id..rep_idd.."mtzwga:") then
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if text == "زوجتي" then
if Redis:get(ZELZAL..msg.chat_id..senderr.."mtzwga:") then
local zwga_id = Redis:get(ZELZAL..msg.chat_id..senderr.."mtzwga:")
...
elseif not Redis:get(ZELZAL..msg.chat_id..senderr.."mtzwga:") then
...
elseif tonumber(rep_idd) == tonumber(ZELZAL) then
return send(msg.chat_id,msg.id,"ابعد عني يبن الحيحانه","md")
elseif tonumber(Redis:get(ZELZAL..msg.chat_id..rep_idd.."mtzwga:")) ~= tonumber(senderr) or tonumber(Redis:get(ZELZAL..msg.chat_id..senderr.."mtzwga:")) ~= tonumber(rep_idd) then
return send(msg.chat_id,msg.id,"مومراتك عشان تطلقها يهبل","md")
elseif tonumber(Redis:get(ZELZAL..msg.chat_id..rep_idd.."mtzwga:")) == tonumber(senderr) or tonumber(Redis:get(ZELZAL..msg.chat_id..senderr.."mtzwga:")) == tonumber(rep_idd) then
Redis:del(ZELZAL..msg.chat_id..rep_idd.."mtzwga:")
Redis:del(ZELZAL..msg.chat_id..senderr.."mtzwga:")
