...
bot.sendText(msg.chat_id,msg.id, "← معندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
bot.sendText(msg.chat_id,msg.id, "← معندك ميداليات","md",true)
end
end
...
return bot.sendText(msg.chat_id,msg.id, "← معندك فلوس ارسل الالعاب وابدأ بجمع الفلوس \n〰","md",true)
end
...
return bot.sendText(msg.chat_id,msg.id,GetName.."\n\n*← حصلت علي : "..Number.. " دولار 💵*\n〰","md",true)
else
bot.sendText(msg.chat_id,msg.id, "← معندك حساب بنكي ","md",true)
end
end
...
return bot.sendText(msg.chat_id,msg.id, "← معندك حساب بنكي ","md",true)
end
...
if Redis:ttl(Fast.."iioo" .. msg.sender_id.user_id) >=60 then
local hours = Redis:ttl(Fast.."iioo" .. msg.sender_id.user_id) / 60
return bot.sendText(msg.chat_id,msg.id,"← من شوي اخذت بخشيش انتضر "..math.floor(hours).." دقيقة","md",true)
end
shkse = Redis:get(Fast.."shkse"..msg.sender_id.user_id)
if shkse == "شريرة" then
...
return bot.sendText(msg.chat_id,msg.id,"← انتا بالسجن 🏤 انتضر "..math.floor(hours).." دقائق\n〰","md",true)
end
...
return bot.sendText(msg.chat_id,msg.id, "← مينفعش تزرفه فلوسه اقل من 200 دولار 💵","md",true)
end
...
return bot.sendText(msg.chat_id,msg.id, "← مينفعش تطور راتبك تحتاج مبلغ 1000000000 دولار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "← مينفعش تطور راتبك تحتاج مبلغ 200000000 دولار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "← مينفعش تطور راتبك تحتاج مبلغ 30000000 دولار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "← مينفعش تطور راتبك تحتاج مبلغ 1000000 دولار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "← مينفعش تطور راتبك تحتاج مبلغ 300000 دولار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "← مينفعش تطور راتبك تحتاج مبلغ 120000 دولار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "← مينفعش تطور راتبك تحتاج مبلغ 80000 دولار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "← مينفعش تطور راتبك تحتاج مبلغ 30000 دولار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "← مينفعش تطور راتبك تحتاج مبلغ 3000 دولار 💵","md",true)
end
Redis:del(Fast.."ratbtrans"..msg.sender_id.user_id)
...
return bot.sendText(msg.chat_id,msg.id,"← خسرت بأخر معركة انتضر "..math.floor(hours).." دقيقة","md",true)
end
...
return bot.sendText(msg.chat_id,msg.id, "← مينفعش تهجم فلوسك اقل من 1000 دولار 💵","md",true)
end
if tonumber(ballanceed) < 1000 then
return bot.sendText(msg.chat_id,msg.id, "← مينفعش تهجم عليه فلوسه اقل من 1000 دولار 💵","md",true)
end
...
return bot.sendText(msg.chat_id,msg.id, "← معندك "..tonumber(coniss).." ماسه","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local mgrmasname = Redis:get(Fast.."mgrmasname"..msg.sender_id.user_id)
local mgrmasprice = Redis:get(Fast.."mgrmasprice"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← معندك "..tonumber(coniss).." قلاده ","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local mgrkldname = Redis:get(Fast.."mgrkldname"..msg.sender_id.user_id)
local mgrkldprice = Redis:get(Fast.."mgrkldprice"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← معندك "..tonumber(coniss).." سوار ","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local mgrswrname = Redis:get(Fast.."mgrswrname"..msg.sender_id.user_id)
local mgrswrprice = Redis:get(Fast.."mgrswrprice"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← معندك "..tonumber(coniss).." خاتم ","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local mgrktmname = Redis:get(Fast.."mgrktmname"..msg.sender_id.user_id)
local mgrktmprice = Redis:get(Fast.."mgrktmprice"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← معندك "..tonumber(coniss).." قصر","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local akrksrname = Redis:get(Fast.."akrksrname"..msg.sender_id.user_id)
local akrksrprice = Redis:get(Fast.."akrksrprice"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← معندك "..tonumber(coniss).." فيلا ","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local akrfelname = Redis:get(Fast.."akrfelname"..msg.sender_id.user_id)
local akrfelprice = Redis:get(Fast.."akrfelprice"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← معندك "..tonumber(coniss).." منزل ","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local akrmnzname = Redis:get(Fast.."akrmnzname"..msg.sender_id.user_id)
local akrmnzprice = Redis:get(Fast.."akrmnzprice"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← معندك "..tonumber(coniss).." طيارة شبح ","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local airshbhname = Redis:get(Fast.."airshbhname"..msg.sender_id.user_id)
local airshbhprice = Redis:get(Fast.."airshbhprice"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← معندك "..tonumber(coniss).." طيارة سفر ","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local airsfarname = Redis:get(Fast.."airsfarname"..msg.sender_id.user_id)
local airsfarprice = Redis:get(Fast.."airsfarprice"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← معندك "..tonumber(coniss).." طيارة خاصه ","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local airkhasname = Redis:get(Fast.."airkhasname"..msg.sender_id.user_id)
local airkhasprice = Redis:get(Fast.."airkhasprice"..msg.sender_id.user_id) or 0
...
if tonumber(airshbhnum) < tonumber(coniss) then
return bot.sendText(msg.chat_id,msg.id, "← معندك "..tonumber(coniss).." طائرة شبح ","md",true)
end
local Remsg = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
if msg.sender_id.user_id == Remsg.sender_id.user_id then
bot.sendText(msg.chat_id,msg.id,"\n*← تهدي نفسك 🤡*","md",true)  
...
if tonumber(airsfarnum) < tonumber(coniss) then
return bot.sendText(msg.chat_id,msg.id, "← معندك "..tonumber(coniss).." طائرة سفر ","md",true)
end
local Remsg = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
if msg.sender_id.user_id == Remsg.sender_id.user_id then
bot.sendText(msg.chat_id,msg.id,"\n*← تهدي نفسك 🤡*","md",true)  
...
if tonumber(airkhasnum) < tonumber(coniss) then
return bot.sendText(msg.chat_id,msg.id, "← معندك "..tonumber(coniss).." طائرة خاصه ","md",true)
end
local Remsg = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
if msg.sender_id.user_id == Remsg.sender_id.user_id then
bot.sendText(msg.chat_id,msg.id,"\n*← تهدي نفسك 🤡*","md",true)  
...
return bot.sendText(msg.chat_id,msg.id, "← معندك "..tonumber(coniss).." سيارة فيلار ","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local carrangname = Redis:get(Fast.."carrangname"..msg.sender_id.user_id)
local carrangprice = Redis:get(Fast.."carrangprice"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← معندك "..tonumber(coniss).." سيارة اكسنت ","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local caraccename = Redis:get(Fast.."caraccename"..msg.sender_id.user_id)
local caracceprice = Redis:get(Fast.."caracceprice"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← معندك "..tonumber(coniss).." سيارة كامري ","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local carcamrname = Redis:get(Fast.."carcamrname"..msg.sender_id.user_id)
local carcamrprice = Redis:get(Fast.."carcamrprice"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← معندك "..tonumber(coniss).." سيارة النترا ","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local caralntrname = Redis:get(Fast.."caralntrname"..msg.sender_id.user_id)
local caralntrprice = Redis:get(Fast.."caralntrprice"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← معندك "..tonumber(coniss).." سيارة هايلكس ","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local carhilxname = Redis:get(Fast.."carhilxname"..msg.sender_id.user_id)
local carhilxprice = Redis:get(Fast.."carhilxprice"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← معندك "..tonumber(coniss).." سيارة سوناتا ","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local carsonaname = Redis:get(Fast.."carsonaname"..msg.sender_id.user_id)
local carsonaprice = Redis:get(Fast.."carsonaprice"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "← معندك "..tonumber(coniss).." سيارة كورولا ","md",true)
end
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
local carcoroname = Redis:get(Fast.."carcoroname"..msg.sender_id.user_id)
local carcoroprice = Redis:get(Fast.."carcoroprice"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.reply_to_message_id, "← معندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if text and text:match('انشاء شركه (.*)') or text and text:match('انشاء شركه (.*)') then
local Cnamed = text:match('انشاء شركه (.*)') or text:match('انشاء شركه (.*)')
if Redis:sismember(Fast.."booob",msg.sender_id.user_id) then
ballanceed = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0

if Redis:sismember(Fast.."in_company:" , msg.sender_id.user_id) then
return bot.sendText(msg.chat_id,msg.id, "← لديك شركه حاليا\n← تستطيع استخدام الامر ( `استقاله` )\n〰","md",true)
end
if Redis:sismember(Fast.."company_owners:",msg.sender_id.user_id) then
return bot.sendText(msg.chat_id,msg.id, "← لديك شركه مسبقاً","md",true)
end
local ballancee = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
...
local convert_mony = string.format("%.0f",ballancee)
bot.sendText(msg.chat_id,msg.id,"• تم انشاء شركتك\n← اسم الشركه : "..Cnamed.."\n← رصيد الشركه : "..convert_mony.." دولار 💵\n← تستطيع اضافة اعضاء معك بالشركه\n← ارسل الامر ( اضافة ) بالرد\n〰","md",true)
else
bot.sendText(msg.chat_id,msg.id, "← معندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
if text and text:match('كشف شركه (.*)') or text and text:match('كشف شركه (.*)') then
local Cname = text:match('كشف شركه (.*)') or text:match('كشف شركه (.*)')
...
return bot.sendText(msg.chat_id,msg.id, "← انت غير موظف في ايششركه","md",true)  
end
...
return bot.sendText(msg.chat_id,msg.id, "← لديه شركه مسبقاً","md",true)
end
local Cname = Redis:get(Fast.."companys_name:"..msg.sender_id.user_id)
local Cmem = Redis:smembers(Fast.."company:mem:"..Cname)
if #Cmem == 5 then
...
return bot.sendText(msg.chat_id,msg.id, "← اللاعب لديه طلب توظيف انتضر يخلص مدته","md",true)
end
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
return bot.sendText(msg.chat_id, msg.reply_to_message_id ,"← صاحب الشركه : "..Cname.."\n← طلب منك العمل معه بالشركه ؟","md",false, false, false, false, reply_markup)
else
bot.sendText(msg.chat_id,msg.id, "← ماعنده حساب بنكي ","md",true)
end
else
...
return bot.sendText(msg.chat_id,msg.id, "← ليس لديك في الشركه مشان تطرده","md",true)  
end
...
return bot.sendText(msg.chat_id,msg.id, "← معندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
--------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------
...
bot.sendAudio(msg.chat_id,msg.id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@GG_EER")
sleep(1)
...
if Redis:ttl(Fast.."iioood" .. msg.sender_id.user_id) >=60 then
local hours = Redis:ttl(Fast.."iioood" .. msg.sender_id.user_id) / 60
return bot.sendText(msg.chat_id,msg.id,"← من شوي عملت سحب انتضر "..math.floor(hours).." دقيقة","md",true)
end
ballanceed = Redis:get(Fast.."boob"..msg.sender_id.user_id) or 0
if tonumber(coniss) < 999 then
return bot.sendText(msg.chat_id,msg.id, "← الحد الادنى المسموح هو 1000 دولار 💵\n〰","md",true)
...
if tonumber(ballancee) < 1 then
return bot.sendText(msg.chat_id,msg.id, "← معندك تبرعات \n〰","md",true)
end
local convert_mony = string.format("%.0f",ballancee)
