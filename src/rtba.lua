...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"•تم تنزيله من اغبياء الكروب").Reply,"md",true)  
else
Redis:srem(Fast.."kholat:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم تنزيله من اغبياء الكروب من قبل ").Reply,"md",true)  
end
end
if TextMsg == "فاشل" then
if not Redis:sismember(Fast.."wtka:Group"..msg_chat_id,rep_idd) then
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم تنزيله من الفاشلين في الكروب ").Reply,"md",true)  
else
Redis:srem(Fast.."wtka:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم تنزيله من الفاشلين في الكروب من قبل ").Reply,"md",true)  
end
end
if TextMsg == "مطي" then
if not Redis:sismember(Fast.."twhd:Group"..msg_chat_id,rep_idd) then
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"تم تنزيله من الصاكين بالكروب ").Reply,"md",true)  
else
Redis:srem(Fast.."twhd:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"تم تنزيله من المطايه بالكروب من قبل ").Reply,"md",true)  
end
end
if TextMsg == "صاك" then
if not Redis:sismember(Fast.."twhd:Group"..msg_chat_id,rep_idd) then
...
Redis:srem(Fast.."twhd:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"•تم تنزيله من الصاكين بالكروب من قبل ").Reply,"md",true)  
end
end
if TextMsg == "ضلعي" then
if not Redis:sismember(Fast.."klb:Group"..msg_chat_id,rep_idd) then
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"•تم تنزيله من ضلوعك بالكروب ").Reply,"md",true)  
else
Redis:srem(Fast.."klb:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"تم تنزيله من ضلوعك بالكروب من قبل ").Reply,"md",true)  
end
end
if TextMsg == "كانسر" then
if not Redis:sismember(Fast.."mar:Group"..msg_chat_id,rep_idd) then
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"تم تنزيله من الكانسريه بالكروب ").Reply,"md",true)  
else
Redis:srem(Fast.."mar:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم تنزيله من الكانسريه بالكروب من قبل ").Reply,"md",true)  
end
end
if TextMsg == "فاهي" then
if not Redis:sismember(Fast.."smb:Group"..msg_chat_id,rep_idd) then
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم تنزيله من الفاهين بالكروب ").Reply,"md",true)  
else
Redis:srem(Fast.."smb:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم تنزيله من الفاهين بالكروب من قبل ").Reply,"md",true)  
end
end
if TextMsg == "قرد" then
if not Redis:sismember(Fast.."2rd:Group"..msg_chat_id,rep_idd) then
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم تنزيله من القرود بالكروب ").Reply,"md",true)  
else
Redis:srem(Fast.."2rd:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم تنزيله من القرود بالكروب من قبل ").Reply,"md",true)  
end
end
if TextMsg == "صخل" then
if not Redis:sismember(Fast.."3ra:Group"..msg_chat_id,rep_idd) then
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم تنزيله من الصخول بالكروب ").Reply,"md",true)  
else
Redis:srem(Fast.."3ra:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم تنزيله من الصخول بالكروب من قبل ").Reply,"md",true)  
end
end
if TextMsg == "احول" then
if not Redis:sismember(Fast.."8by:Group"..msg_chat_id,rep_idd) then
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم تنزيله من حولان بالكروب ").Reply,"md",true)  
else
Redis:srem(Fast.."8by:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم تنزيله من حولان بالكروب من قبل ").Reply,"md",true)  
end
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"•تم رفعه مطي بالكروب ").Reply,"md",true)  
else
Redis:sadd(Fast.."kholat:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم رفعه مطي بالكروب من قبل  ").Reply,"md",true)  
end
end
if TextMsg == "صاك" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم رفعه صاك بالكروب ").Reply,"md",true)  
else
Redis:sadd(Fast.."wtka:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم رفعه صاك بالكروب من قبل ").Reply,"md",true)  
end
end
if TextMsg == "غبي" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم رفعه غبي بالكروب ").Reply,"md",true)  
else
Redis:sadd(Fast.."twhd:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم رفعه غبي بالكروب من قبل ").Reply,"md",true)  
end
end
if TextMsg == "فاشل" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"•تم رفعه ضلع بالكروب ").Reply,"md",true)  
else
Redis:sadd(Fast.."klb:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم رفعه ضلع بالكروب من قبل ").Reply,"md",true)  
end
end
if TextMsg == "صخل" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم رفعه صخل بالكروب ").Reply,"md",true)  
else
Redis:sadd(Fast.."mar:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم رفعه صخل بالكروب من قبل  ").Reply,"md",true)  
end
end
if TextMsg == "كانسر" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم رفعه كانسر بالكروب ").Reply,"md",true)  
else
Redis:sadd(Fast.."smb:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم رفعه كانسر بالكروب من قبل ").Reply,"md",true)  
end
end
if TextMsg == "قرد" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"•تم رفعه قرد بالكروب ").Reply,"md",true)  
else
Redis:sadd(Fast.."2rd:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم رفعه قرد بالكروب من قبل ").Reply,"md",true)  
end
end
if TextMsg == "احول" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"•تم رفعه احول بالكروب ").Reply,"md",true)  
else
Redis:sadd(Fast.."3ra:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم رفعه احول بالكروب من قبل ").Reply,"md",true)  
end
end
if TextMsg == "فاهي" then
if ChannelJoin(msg) == false then
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم رفعه فاهي بالكروب ").Reply,"md",true)  
else
Redis:sadd(Fast.."8by:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم رفعه فاهي بالكروب من قبل ").Reply,"md",true)  
end
end
end
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"• لا يوجد مطايه حاليا , ","md",true)  
end
ListMembers = '\n*• قائمة المطايه  \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n'
for k, v in pairs(Info_Members) do
local UserInfo = bot.getUser(v)
...
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {{{text = '- مسح المطايه', data = senderr..'/Delkholat'},},}}
return send(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {{{text = '- مسح الصاكين', data = senderr..'/Delwtk'},},}}
return send(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
if text == 'الضلوع' then
if ChannelJoin(msg) == false then
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"•لا يوجد ضلوع حاليا, ","md",true)  
end
ListMembers = '\n*• قائمة الضلوع  \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n'
for k, v in pairs(Info_Members) do
local UserInfo = bot.getUser(v)
...
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {{{text = '- مسح الضلوع', data = senderr..'/Deltwhd'},},}}
return send(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {{{text = '- مسح الاغبياء', data = senderr..'/Delklb'},},}}
return send(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
if text == 'الحولان' then
if ChannelJoin(msg) == false then
local chinfo = Redis:get(Fast.."ch:admin")
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = chinfo}, },}}
return send(msg.chat_id,msg.id,'*\n• عليك الاشتراك في 𝕊𝕆𝕌ℝℂ𝔼 ℂ𝔸ℝ𝕆𝕃𝕌𝕊 لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"• لا يوجد حولان حاليا  , ","md",true)  
end
ListMembers = '\n*• قائمة الحولان  \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n'
for k, v in pairs(Info_Members) do
local UserInfo = bot.getUser(v)
...
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {{{text = '- مسح الحولان', data = senderr..'/Delmar'},},}}
return send(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
if text == 'الصخول' then
if ChannelJoin(msg) == false then
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"• لا يوجد صخول حاليا , ","md",true)  
end
ListMembers = '\n*• قائمة الصخول  \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n'
for k, v in pairs(Info_Members) do
local UserInfo = bot.getUser(v)
...
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {{{text = '- مسح الصخول', data = senderr..'/Del3ra'},},}}
return send(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
if text == 'الفاهين' then
if ChannelJoin(msg) == false then
local chinfo = Redis:get(Fast.."ch:admin")
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = chinfo}, },}}
return send(msg.chat_id,msg.id,'*\n• عليك الاشتراك في 𝕊𝕆𝕌ℝℂ𝔼 ℂ𝔸ℝ𝕆𝕃𝕌𝕊 لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"• لا يوجد فاهين حاليا , ","md",true)  
end
ListMembers = '\n*• قائمة الفاهين  \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n'
for k, v in pairs(Info_Members) do
local UserInfo = bot.getUser(v)
...
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {{{text = '- مسح الفاهين', data = senderr..'/Delsmb'},},}}
return send(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
if text == 'القرود' then
if ChannelJoin(msg) == false then
...
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"• لا يوجد كانسريه حاليا  , ","md",true)  
end
ListMembers = '\n*• قائمة الكانسريه  \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉*\n'
for k, v in pairs(Info_Members) do
local UserInfo = bot.getUser(v)
...
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {{{text = '- مسح الكانسريه', data = senderr..'/Del8by'},},}}
return send(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
if text == 'رتبتي' then
local ban = (msg.sender_id.user_id)
local news = '✧ رتبتك هي : '..msg.Name_Controller
local reply_markup =replyMarkup{type = 'inline',data = {
