...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم حظره من الكروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fast.."BanGroup:Group"..msg_chat_id,rep_idd) 
bot.setChatMemberStatus(msg.chat_id,rep_idd,'banned',0)
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم حظره من الكروب ").Reply,"md",true)  
end
end
...
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم كتمه في الكروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Fast.."SilentGroup:Group"..msg_chat_id,rep_idd) 
return send(msg_chat_id,msg_id,Reply_Status(rep_idd,"• تم كتمه في الكروب  ").Reply,"md",true)  
end
end
...
if KickMe == true then
return send(msg_chat_id,msg_id,"*• عذرا لا استطيع طرد ادامن ومنشئين الكروب*","md",true)    
end
...
if text == 'ادامن الكروب' or text == 'المشرفين' then
if not msg.Manger then
return send(msg_chat_id,msg_id,'\n*• هذا الامر يخص { '..Controller_Num(6)..' }* ',"md",true)  
end
if ChannelJoinch(msg) == false then
...
if text == 'تفعيل الاشتراك الاجباري للكروب' then
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*• هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
...
if text == 'تعطيل الاشتراك الاجباري للكروب' then
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*• هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
...
if text == 'تغيير الاشتراك الاجباري للكروب' then
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*• هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
Redis:set(Fast..'Chat:Channel:Redis'..msg_chat_id..':'..senderr,true)
...
if text == 'الاشتراك الاجباري للكروب' then
if not msg.Asasy then 
return send(msg_chat_id,msg_id,'\n*• هذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
...
return send(msg_chat_id,msg_id,"⌯︙تم تفعيل جلب نسخة الكروبات التلقائية","md")
end
...
return send(msg_chat_id,msg_id,"⌯︙تم تعطيل جلب نسخة الكروبات التلقائية","md")
end
